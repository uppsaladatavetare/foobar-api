    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(null=True, verbose_name='date modified', auto_now=True)),
                ('id', models.UUIDField(editable=False, primary_key=True, serialize=False, default=uuid.uuid4)),
                ('account', models.ForeignKey(to='foobar.Account')),
            ],
            options={
                'abstract': False,
            },
